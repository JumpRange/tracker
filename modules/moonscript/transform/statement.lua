local Transformer
Transformer = require("modules.moonscript.transform.transformer").Transformer
local NameProxy, LocalName, is_name_proxy
do
  local _obj_0 = require("modules.moonscript.transform.names")
...
do
  local _obj_0 = require("modules.moonscript.transform.statements")
...
local types = require("modules.moonscript.types")
...
local insert
insert = table.insert
local destructure = require("modules.moonscript.transform.destructure")
local construct_comprehension
construct_comprehension = require("modules.moonscript.transform.comprehension").construct_comprehension
local unpack
unpack = require("modules.moonscript.util").unpack
...
return Transformer({
  ...
  ["return"] = function(self, node)
    ...
    if ret_val_type == "chain" or ret_val_type == "comprehension" or ret_val_type == "tblcomprehension" then
      local Value = require("modules.moonscript.transform.value")
  ...
  class = require("modules.moonscript.transform.class")
})
