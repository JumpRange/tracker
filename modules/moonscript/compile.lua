local util = require("modules.moonscript.util")
local dump = require("modules.moonscript.dump")
local transform = require("modules.moonscript.transform")
...
local Set
Set = require("modules.moonscript.data").Set
...
local statement_compilers = require("modules.moonscript.compile.statement")
local value_compilers = require("modules.moonscript.compile.value")
local concat, insert
do
  local _obj_0 = table
...
do
  local data = require("modules.moonscript.data")
