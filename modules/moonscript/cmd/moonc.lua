...
local split
split = require("modules.moonscript.util").split
...
compile_file_text = function(text, opts)
  ...
  local parse = require("modules.moonscript.parse")
  local compile = require("modules.moonscript.compile")
  local parse_time
  ...
  if opts.show_posmap then
    local debug_posmap
    debug_posmap = require("modules.moonscript.util").debug_posmap
    print("Pos", "Lua", ">>", "Moon")
